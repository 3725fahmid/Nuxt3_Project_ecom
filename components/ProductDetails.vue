<template>
    ...
    <div class="back">
        <nuxt-link to="/product"><button
                class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Back
                to Product Page</button></nuxt-link>
    </div>
</template>
